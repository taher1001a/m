        ...
        printArea.innerHTML = `
            <div class="invoice">
                <div class="inv-header">
                    ...
                    ${client ? `<div>العميل: ${client.name}</div>` : ''}
                </div>
                ${itemsHTML}
                <div class="inv-total">
                    ...
                    ${invoice.total - invoice.paid > 0 ? `<div class="inv-row"><span>المتبقي</span><span>${Utils.formatMoney(invoice.total - invoice.paid, currency)}</span></div>` : ''}
                </div>
